  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        var cubit = AppCubit.get(context).kidsProducts;
        return Scaffold(
          body: ConditionalBuilder(
              condition: AppCubit.get(context).kidsProducts != null,
              builder: (context) {
                      ...
                      Container(
                        ...
                        child: GridView.count(
                          ...
                          children: List.generate(
                              AppCubit.get(context).kidsProducts!.length,
                              (index) {
...
//             crossAxisSpacing: 1,
//             childAspectRatio: 1 / 1.46,
//             children: List.generate(AppCubit.get(context).kidsCategory!.length,
//                 (index) {
//               return InkWell(
//                 onTap: () {
